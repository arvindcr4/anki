...
- card-creation affordances from the daily cards surface, including context-aware create/import actions with momentum-aware import wording, a zero-to-first-card prompt with import fallback, a capture-enabled Today bar, a resume-last-capture fallback on empty Today, and a keep-capturing shortcut for Today
