...
- clickable browse-by-date actions, including date-labeled today, week-range, date-bounded streak, date-labeled burst-day review, resume-your-last-capture, panel-level busiest-day recovery, and summary-pill shortcuts
...
- momentum cues such as active/quiet day balance, consistency, gap, visible range, pace, trend, density, burst share, streaks, busiest-day summaries, and next-step guidance so the panel encourages continuity, not just navigation, with density remaining directly browseable when users want to inspect high-card-output weeks
- context-sensitive guidance and row actions so the right next step is one click away, including trend-aware restart prompts, consistency nudges, visually emphasized resume-last-capture shortcuts, burst-review followups, and recovery imports
