...
checks = [
    ...
    ('7 day activity strip', 1, 'visual'),
    ('daily-cards-bar', 2, 'visual'),
    ('is-streak-bar', 1, 'visual'),
    ('is-latest-bar', 1, 'visual'),
    ('is-busiest-bar', 1, 'visual'),
    ('is-burst-bar', 1, 'visual'),
    ('daily-cards-bar-label', 1, 'visual'),
    ('daily-cards-bar-date', 1, 'visual'),
    ...
    ('Consistency:', 2, 'timeline'),
    ('% active', 2, 'timeline'),
    ('Browse weekly consistency context', 2, 'browse'),
    ('Browse latest capture', 2, 'browse'),
    ('Browse active week', 2, 'browse'),
    ('Browse quiet week context', 2, 'browse'),
    ('Browse visible week', 2, 'browse'),
    ('Gap:', 2, 'timeline'),
    ...
    ('Pace:', 2, 'timeline'),
    ('cards/active day', 2, 'timeline'),
    ('Browse weekly pace context', 2, 'browse'),
    ('daily-cards-trend', 1, 'visual'),
    ('Trend:', 2, 'timeline'),
    ('Trend: rising', 1, 'timeline'),
    ('Trend: cooling', 1, 'timeline'),
    ('Trend: steady', 1, 'timeline'),
    ('Trend: just started', 1, 'timeline'),
    ('Browse weekly trend context', 2, 'browse'),
    ('daily-cards-burst', 1, 'visual'),
    ('Burst:', 2, 'timeline'),
    ...
    ('Browse weekly density context', 2, 'browse'),
    ('Current streak', 2, 'timeline'),
    ('Last streak', 2, 'timeline'),
    ('daily-cards-streak', 1, 'visual'),
    ('Browse current streak (', 1, 'browse'),
    ('Browse last streak (', 1, 'browse'),
    ('daily-cards-insight', 2, 'timeline'),
    ('daily-cards-insight-link', 1, 'visual'),
    ('Review burst-heavy week', 2, 'browse'),
    ('Browse recent trend', 2, 'browse'),
    ('is-burst', 1, 'visual'),
    ('is-rising', 1, 'visual'),
    ('is-cooling', 1, 'visual'),
    ('is-consistent', 1, 'visual'),
    ('is-spread', 1, 'visual'),
    ('Insight:', 2, 'timeline'),
    ('one big capture session', 1, 'timeline'),
    ('recent capture is accelerating', 1, 'timeline'),
    ('recent capture has cooled', 1, 'timeline'),
    ('capture has been consistent', 1, 'timeline'),
    ('daily-cards-guidance', 2, 'timeline'),
    ('daily-cards-guidance-block', 1, 'visual'),
    ('role="status"', 1, 'visual'),
    ('aria-live="polite"', 1, 'visual'),
    ...
    ('Import to rebuild momentum', 2, 'capture'),
